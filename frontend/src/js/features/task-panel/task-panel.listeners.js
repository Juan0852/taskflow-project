...
export const TaskAddPanel = {
    ...
    handleConfirmClick(gui) {
        ...
        const didSubmit = TaskPanelService.submitTask(TaskPanelViewModel.getSubmitContext(payload));
        if (!didSubmit) return;
    ...
    openForCreate(gui) {
        ...
        TaskPanelView.renderTypeSuggestions(gui, TaskPanelService.getAvailableTypes());
